    ...
    record.forEach(function (element) {
      ...
      switch (record_type) {
        ...
        case 'R':
          ...
          // R|1|^^^Ren|5.3|�IU/mL||N||F||||20190525155433|Liaison
          ...
          if(flag == ">" || flag == "<"){
            fresult = flag + " " + fresult
          }

          // Unicode Decimal Code &#65533;
          // Symbol Name:	Replacement Character
          if(fjedinica.charCodeAt(0) == "65533"){
            fjedinica = "µ" + result[4].substring(1);
          }
                        ...
                        if (test === null) {
                          ...
                          uzorak.tests.forEach(elementu => {
                            ...
                            if ((elementu.labassay.sifra.trim() === test.test.sifra.trim() && elementu.status_t === "U OBRADI") || (elementu.labassay.sifra.trim() === test.test.sifra.trim() && elementu.status_r)) {
                              ...
                              rezultat.jedinice_f = object.jedinica_f
