          ...
          record.forEach(function(element) {
              ...
              switch (record_type) {
                          ...
                          case 'O':
                                    ...
                                    break;
                          case 'R':
                                    // 'H|\\^&|||URISYS1100^Inst^V2.0^INT|||||||P||20200714210947',             
                                    // 'O|1|CM           |001^00058^C10|Urinalysis&S&Incubated|R||||||X|||20200714210947',
                                    // 'R|01|01&S& SG|1.005|g/cm3|||||20080724|(OFF)',
                                    var result = element.split("|")
                                    vrijeme_prijenosa = Date.now()
                                    //analit =result[2].split('^')[1]
                                   
                                     rezultati.push({
                                      analit:result[2].split('^')[1].trim(),
                                      analit_rez:result[3].split('^')[0].trim(),
                                      ...
                                      if (err) {
                                        ...
                                        if(rezultat){
                                          ...
                                          if(rezultat.multi.length){
                                            ...
                                            console.log('rezultati.length:'+rezultati.length)
