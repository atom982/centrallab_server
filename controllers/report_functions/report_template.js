        ...
        switch (code) {
          case "B": // Skenderija
            ...
            doc
              ...
              .fontSize(10.5)
              .fillColor("black")
              .text("Tel: +387 (0) 35 81 63 17", 345, 32.5 - 3 - 12.5);
            doc
              .font("PTSansRegular")
              .fontSize(10.5)
              .fillColor("black")
              .text("Mob: +387 (0) 62 73 73 03 (+viber+WhatsApp)", 345, 45 - 3 - 12.5)
            doc
              .font("PTSansRegular")
              .fontSize(10.5)
              .fillColor("black")
              .text("\xa0\xa0\xa0\xa0\xa0+387 (0) 61 23 47 05 (+viber+WhatsApp)", 345, 57.5 - 3 - 12.5);
